...
namespace Day8Part2
{
    internal class Program
    {
        ...
        {
            DataTable dt = Create();
            insert(dt, "P00011", "Mobile", 560, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00012", "Laptop", 4500, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00013", "Cloaths", 350, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00014", "cycle", 850, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00015", "Bike", 450, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00016", "Car", 865, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00017", "PenDrive", 250, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00018", "Food", 1250, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00019", "rice", 665, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            insert(dt, "P00020", "Wheate", 785, new DateTime(day: 12, month: 12, year: 2022), new DateTime(day: 09, month: 12, year: 2023));
            Display(dt);
